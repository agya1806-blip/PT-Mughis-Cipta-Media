    ...
    <section className="relative py-24 lg:py-32 bg-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <span className="text-green font-semibold text-sm tracking-widest uppercase">Tentang Kami</span>
            ...
            <div className="space-y-5 text-green/80 leading-relaxed">
              ...
              <p className="text-lg">
                Dari naskah mentah hingga menjadi buku yang siap dinikmati masyarakat, kami mendampingi setiap langkah dengan penuh dedikasi. Percetakan berkualitas, desain yang memikat, distribusi yang luas, dan dukungan penuh terhadap pengembangan literasi menjadi pilar utama layanan kami.
              </p>
            </div>
