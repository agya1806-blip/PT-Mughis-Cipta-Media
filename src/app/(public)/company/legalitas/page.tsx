      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-950 dark:to-zinc-900 pt-20 sm:pt-24 lg:pt-32 pb-16 sm:pb-20">
        ...
        <div className="container relative">
          <Breadcrumb
            items={[
              { label: "Beranda", href: "/" },
              { label: "Profil Perusahaan", href: "/company" },
              { label: "Legalitas" },
            ]}
          />
          <motion.div
          ...
          >
            ...
            <p className="mt-6 text-lg sm:text-xl text-zinc-500 dark:text-zinc-400 leading-relaxed">
              PT Mughis Cipta Media memiliki legalitas lengkap dan terdaftar resmi di instansi
              pemerintah terkait. Seluruh dokumen legal dapat diverifikasi melalui instansi
              berwenang.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16">
            <div className="space-y-10">
              <SectionTitle
                ...
                title="Surat & Dokumen"
                accent="Resmi"
                description="Dokumen legalitas yang dimiliki PT Mughis Cipta Media sebagai perusahaan berbadan hukum resmi."
                align="left"
              />
                ...
                {legalDocuments.map((doc) => {
                  ...
                  return (
                    <motion.div
                      key={doc.id}
                      variants={MOTION.fadeUp}
                      className="group relative bg-white dark:bg-zinc-800/50 rounded-2xl p-6 border border-zinc-200 dark:border-zinc-700/30 hover:border-gold/30 hover:shadow-md transition-all duration-300"
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-wrap items-center gap-2 mb-2">
                            ...
                            <LegalBadge
                              icon={CheckCircle}
                              title={doc.status === "verified" ? "Terverifikasi" : "Aktif"}
                              status={doc.status}
                            />
                          </div>
            ...
            <div className="space-y-10">
              <SectionTitle
                ...
                title="Nomor Induk"
                accent="Berusaha"
                description="NIB adalah identitas legal usaha yang diterbitkan oleh Pemerintah Indonesia melalui sistem OSS-RBA."
                align="left"
              />
                ...
                <GlassPanel intensity="medium" className="p-8 space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-zinc-900 dark:text-white font-mono tracking-wider">
                        1234567890123
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 text-sm text-gold">
                    ...
                    <span className="font-medium">Telah terverifikasi oleh OSS-RBA</span>
                  </div>
                </GlassPanel>
              </motion.div>
              ...
              >
                <GlassPanel intensity="light" className="p-8 space-y-5">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="font-bold text-zinc-900 dark:text-white">Sertifikasi & Keanggotaan</h3>
                  </div>
                  <div className="space-y-4">
                    {[
      ...
      <section className="relative py-24 overflow-hidden bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900">
        ...
        <div className="container relative text-center max-w-2xl">
          ...
          <p className="mt-4 text-lg text-zinc-400">
            Dengan legalitas lengkap dan komitmen terhadap kualitas, PT Mughis Cipta Media siap
            menjadi mitra penerbitan Anda.
          </p>
