        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="relative mt-10 pl-6 border-l-4 border-gold">
              <Quote className="absolute -left-3 -top-2 w-6 h-6 text-green bg-cream" />
            ...
            >
              <Link
                href="/tentang-kami"
                className="inline-flex items-center gap-2 text-sm font-medium text-green hover:text-green-dark transition-colors group"
              >
                Baca Cerita Lengkap
