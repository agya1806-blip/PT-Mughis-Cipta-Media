...
export const metadata = {
  ...
  description: "Kebijakan privasi PT Mughis Cipta Media — penerbit buku dan percetakan di Aceh. Informasi mengenai pengumpulan, penggunaan, dan perlindungan data pribadi pengguna.",
  openGraph: {
    title: "Kebijakan Privasi - PT Mughis Cipta Media",
    description: "Kebijakan privasi PT Mughis Cipta Media mengenai perlindungan data pribadi pengguna.",
