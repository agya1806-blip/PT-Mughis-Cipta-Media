...
export default async function Footer() {
  const [instagramUrl, facebookUrl, address, phone] = await Promise.all([
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          <div>
            ...
            <p className="mt-2 text-sm">PT Mughis Cipta Media</p>
            <p className="mt-1 text-sm">{address || "Jl. Contoh Alamat No. 123, Jakarta Selatan"}</p>
            {phone && (
              <p className="mt-1 text-sm">
                <a href={`https://wa.me/${phone}`} className="hover:text-emerald-400 transition-colors">
                  {phone}
                </a>
              </p>
            )}
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2">
              <li>
                <Link href="/" className="text-sm transition-colors hover:text-emerald-400">Home</Link>
              </li>
              <li>
                <Link href="/tentang-kami" className="text-sm transition-colors hover:text-emerald-400">Tentang Kami</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="mt-2 flex space-x-4">
              {facebookUrl && (
                <a href={facebookUrl} target="_blank" className="text-gray-400 transition-colors hover:text-emerald-400" aria-label="Facebook">
              ...
              {instagramUrl && (
                <a href={instagramUrl} target="_blank" className="text-gray-400 transition-colors hover:text-emerald-400" aria-label="Instagram">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
