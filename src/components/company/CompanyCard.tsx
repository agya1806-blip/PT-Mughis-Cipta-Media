...
export default function CompanyCard({ icon: Icon, title, description, index = 0 }: Props) {
  return (
    ...
    >
      <div className="relative h-full bg-white dark:bg-zinc-800/50 rounded-2xl p-6 sm:p-8 border border-zinc-200 dark:border-zinc-700/30 hover:border-gold/30 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
