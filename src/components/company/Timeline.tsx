    ...
    <section className="py-24 lg:py-32 bg-cream overflow-hidden">
      <div className="container">
        <div className="max-w-2xl mx-auto text-center mb-16">
          <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-gold/10 border border-gold/20 text-green-dark text-[11px] font-medium uppercase tracking-[0.1em] mb-6">Perjalanan Perusahaan</span>
              ...
              return (
                <motion.div key={i} variants={MOTION.fadeUp} className="relative pl-14">
                  ...
                  <div className="bg-cream rounded-2xl p-6 border border-gold/20 hover:border-gold/40 transition-all duration-300">
                    <span className="inline-block px-3 py-1 rounded-full bg-gold/10 text-green-dark text-xs font-semibold mb-3">{milestone.year}</span>
