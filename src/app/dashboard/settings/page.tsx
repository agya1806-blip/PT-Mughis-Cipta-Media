                  ...
                  <div className="flex gap-3">
                    {["Light", "Dark", "System"].map((mode) => (
                      <button key={mode} className={`flex-1 px-4 py-3 rounded-xl border text-sm font-medium transition-all duration-200 ${
                        mode === "Light" ? "bg-gold/10 border-gold/30 text-gold-dark dark:text-gold" : "border-gold/20 dark:border-gold/10 text-green/70 dark:text-gold/80 hover:border-gold/30"
                      }`}>{mode}</button>
                    ))}
                  </div>
                </div>
