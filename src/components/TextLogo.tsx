...
const styles = {
  ...
  card: { wrapper: "flex items-center gap-1.5", pt: "text-gold text-xs font-semibold tracking-wider", name: "text-green-dark font-bold text-base" },
  inline: { wrapper: "flex items-center gap-1", pt: "text-gold text-[10px] font-semibold tracking-wider", name: "text-green-dark font-bold text-xs" },
}
