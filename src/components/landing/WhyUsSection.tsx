...
const reasons = [
  {
    icon: Building2,
    label: "Legalitas Lengkap",
    desc: "Perusahaan berbadan hukum PT dengan NIB dan izin usaha resmi",
  },
  {
    icon: FileCheck,
    label: "PT Resmi & NIB",
    desc: "Dokumen legalitas lengkap dan transparan untuk kebutuhan mitra",
  },
  {
    icon: Users,
    label: "Tim Berpengalaman",
    desc: "Didukung tim profesional yang berpengalaman di bidang penerbitan",
  },
  {
    icon: Award,
    label: "Kualitas Premium",
    desc: "Standar kualitas tinggi di setiap tahap produksi buku",
  },
  {
    icon: BadgeCheck,
    label: "Harga Kompetitif",
    desc: "Harga terbaik tanpa mengorbankan kualitas hasil cetakan",
  },
  {
    icon: MapPin,
    label: "Nasional",
    desc: "Melayani pengiriman ke seluruh wilayah Indonesia",
  },
]
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="mt-4 text-zinc-500 dark:text-zinc-400 leading-relaxed">
              ...
              Setiap proyek ditangani dengan penuh tanggung jawab dan perhatian terhadap detail.
            </p>
          </motion.div>
