...
export default function AboutCTA() {
  return (
    <section className="relative py-24 lg:py-32 overflow-hidden">
      ...
      <div className="absolute top-10 left-10 w-64 h-64 bg-emerald-400/10 rounded-full blur-3xl animate-pulse" />
      <div className="absolute bottom-10 right-10 w-48 h-48 bg-amber-400/10 rounded-full blur-3xl animate-pulse" />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              href="/kontak"
              className="group inline-flex items-center gap-2 px-8 py-4 bg-white text-emerald-700 font-semibold rounded-2xl hover:bg-emerald-50 transition-all duration-300 shadow-lg shadow-emerald-900/20"
            >
