          ...
          <div className="space-y-3">
            {instagramUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-zinc-600 hover:text-pink-600 transition-colors text-sm"
              >
            ...
            {facebookUrl && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-zinc-600 hover:text-blue-600 transition-colors text-sm"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
