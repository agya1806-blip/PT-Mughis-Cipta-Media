...
const styles = {
  navbar: { wrapper: "flex items-center gap-1.5", pt: "text-gold text-[10px] sm:text-xs font-semibold tracking-wider", name: "text-green-dark font-bold text-sm sm:text-base" },
