      ...
      <div className="text-center max-w-lg">
        <div className="relative mb-8">
          <svg className="w-48 h-48 mx-auto" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="100" cy="100" r="90" className="stroke-gold/20" strokeWidth="2" />
            ...
            <path d="M30 170 Q60 140 100 150 Q140 160 170 130" className="stroke-gold/20" strokeWidth="2" fill="none" strokeLinecap="round" />
            <circle cx="75" cy="85" r="4" className="fill-gold/20" />
            <circle cx="125" cy="85" r="4" className="fill-gold/20" />
            <path d="M85 100 Q100 110 115 100" className="stroke-gold/20" strokeWidth="2" fill="none" strokeLinecap="round" />
          </svg>
        </div>
