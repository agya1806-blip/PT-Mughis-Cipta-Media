...
import {
  BookOpen, FileEdit, Search, Layout, Palette, Hash,
  Printer, Truck, PenTool, Monitor,
} from "lucide-react"
      ...
      <div className="container">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gold/10 border border-gold/20 mb-6">
            <span className="text-gold text-xs font-medium uppercase tracking-wider">Layanan</span>
          </div>
          ...
          <p className="mt-4 text-zinc-500 dark:text-zinc-400 max-w-2xl mx-auto">
            Dari hulu ke hilir — kami menangani seluruh proses penerbitan dengan standar kualitas tertinggi
          </p>
        </motion.div>
